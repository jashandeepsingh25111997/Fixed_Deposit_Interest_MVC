        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedDepositPercentage = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalculatedBalance", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CalculatedBalance_Account_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalculatedBalance_AccountId",
                table: "CalculatedBalance",
                column: "AccountId");
